...
//	}
	...
	public static Object getFieldValue(final Object object,
		...
		try {
			...
			com.blankj.utilcode.utils.LogUtils.d("不可能抛出的异常{}" + e.getMessage());
		}
		return result;
	}
	...
	protected static Field getDeclaredField(final Object object,
		...
		if (object == null || TextUtils.isEmpty(fieldName)) {
			com.blankj.utilcode.utils.LogUtils.d("object或者fieldname不能为null");
			return null;
		}
	...
	protected static Method getDeclaredMethod(Object object, String methodName,
		...
		if (object == null) {
			com.blankj.utilcode.utils.LogUtils.d("object不能为空");
		}
	...
	public static Class getSuperClassGenricType(final Class clazz,
		...
		if (!(genType instanceof ParameterizedType)) {
			com.blankj.utilcode.utils.LogUtils.d(clazz.getSimpleName()
		...
		if (index >= params.length || index < 0) {
			com.blankj.utilcode.utils.LogUtils.d("Index: " + index + ", Size of " + clazz.getSimpleName()
